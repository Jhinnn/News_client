...
class Api {
  static Future<List<Cards>?> getBaiduNews() async {
    ...
    var data = await Dio().get('https://top.baidu.com/api/board?platform=wise&tab=realtime');
  ...
  static Future<List<weibo.CardGroup>> getWeiboNews() async {
    var data = await Dio().get('https://m.weibo.cn/api/container/getIndex?containerid=106003type%3D25%26t%3D3%26disable_hot%3D1%26filter_type%3Drealtimehot');
